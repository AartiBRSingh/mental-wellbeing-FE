      ...
      <main className="flex flex-col md:flex-row justify-center items-center w-[90vw] md:w-[80vw] lg:w-[60vw] gap-8 md:gap-0">
        ...
        <section className="flex-1 flex justify-center md:justify-end bg-transparent mt-8 md:mt-0">
          <div className="relative w-[300px] sm:w-[400px] md:w-[500px] h-[300px] sm:h-[350px] md:h-96">
            {/* Top Image */}
            <div className="absolute lg:top-4 lg:right-1/4 right-10 -top-14 transform -translate-x-1/2 scale-75 sm:scale-90 md:scale-100">
            ...
            {/* Middle Image */}
            <div className="absolute lg:top-1/4 top-2 lg:right-0 -right-6 scale-75 sm:scale-90 md:scale-100">
              <div className="relative">
