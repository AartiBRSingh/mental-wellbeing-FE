...
import LoginModal from "../components/LoginModal"; // Example path
...
const HealPoint = () => {
  ...
  const subscribeUser = async () => {
    // If no user ID, open login modal
    if (!userId) {
    ...
    try {
      const response = await axios.put(`${baseURL}/users/${userId}/subscribe`, {
        email: email,
      });
