...
const Page = () => {
  ...
  return (
    <>
      {/* Background Image - Fixed Position with lower z-index */}
      <div
        ...
        style={{
          ...
          opacity: 0.1,
          zIndex: -1, // Ensure background is below everything
        }}
      />
                    ...
                    >
                      ...
                      >
                        <div className="flex justify-between items-center">
                          ...
                          <span className="ml-6 flex-shrink-0 transition-transform duration-300 ease-in-out">
                            <svg
                              className={`h-6 w-6 text-gray-500 transform ${
